...
var zdogParent = document.querySelector('.zdog');
console.log(zdogParent)
var canvas = zdogParent.querySelector('canvas');
var ctx = canvas.getContext('2d');
var w = 80;
var h = 80;
// var minWindowSize = Math.min(parentRect.width, parentRect.height);
...
function update() {
  camera.rotate.y += isRotating ? +TAU / 360 : 0;
